...
"}")
        ...
        self.logoButton = QtWidgets.QPushButton(parent=self.headerFrame)
        ...
        self.logoButton.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        ...
        self.accountFrame = QtWidgets.QFrame(parent=self.headerFrame)
        self.accountFrame.setMaximumSize(QtCore.QSize(16777215, 40))
        self.accountFrame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.accountFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.accountFrame.setObjectName("accountFrame")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.accountFrame)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.userNameLabel = QtWidgets.QLabel(parent=self.accountFrame)
        self.userNameLabel.setObjectName("userNameLabel")
        self.verticalLayout_6.addWidget(self.userNameLabel)
        self.userRoleLabel = QtWidgets.QLabel(parent=self.accountFrame)
        self.userRoleLabel.setObjectName("userRoleLabel")
        self.verticalLayout_6.addWidget(self.userRoleLabel)
        self.horizontalLayout_3.addWidget(self.accountFrame)
        ...
        self.searchByComboBox.setMinimumSize(QtCore.QSize(105, 40))
        ...
        self.tableHeaderFrame = QtWidgets.QFrame(parent=self.dataFrame)
        ...
        self.tableHeaderFrame.setObjectName("tableHeaderFrame")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.tableHeaderFrame)
        self.horizontalLayout_2.setContentsMargins(5, 0, 5, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.idNumberLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        self.idNumberLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.idNumberLabel.setObjectName("idNumberLabel")
        self.horizontalLayout_2.addWidget(self.idNumberLabel)
        self.nameLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        self.nameLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.nameLabel.setObjectName("nameLabel")
        self.horizontalLayout_2.addWidget(self.nameLabel)
        self.genderLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        ...
        self.yearLevelLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        self.yearLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.yearLevelLabel.setObjectName("yearLevelLabel")
        self.horizontalLayout_2.addWidget(self.yearLevelLabel)
        self.programLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        self.programLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.programLabel.setObjectName("programLabel")
        self.horizontalLayout_2.addWidget(self.programLabel)
        self.collegeLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        self.collegeLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.collegeLabel.setObjectName("collegeLabel")
        self.horizontalLayout_2.addWidget(self.collegeLabel)
        self.operationLabel = QtWidgets.QLabel(parent=self.tableHeaderFrame)
        self.operationLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.operationLabel.setObjectName("operationLabel")
        self.horizontalLayout_2.addWidget(self.operationLabel)
        ...
        self.verticalLayout_4.addWidget(self.tableHeaderFrame)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.userNameLabel.setText(_translate("mainWindow", "Kim Gabriel A. Nasayao"))
        self.userRoleLabel.setText(_translate("mainWindow", "Admin"))
        ...
        self.searchByComboBox.setItemText(0, _translate("mainWindow", "ID Number"))
        self.searchByComboBox.setItemText(1, _translate("mainWindow", "First Name"))
        self.searchByComboBox.setItemText(2, _translate("mainWindow", "Last Name"))
        self.searchByComboBox.setItemText(3, _translate("mainWindow", "Program"))
        self.searchByComboBox.setItemText(4, _translate("mainWindow", "College"))
        ...
        self.sortByComboBox.setItemText(0, _translate("mainWindow", "ID Number"))
        self.sortByComboBox.setItemText(1, _translate("mainWindow", "First Name"))
        self.sortByComboBox.setItemText(2, _translate("mainWindow", "Last Name"))
        self.sortByComboBox.setItemText(3, _translate("mainWindow", "Gender"))
        self.sortByComboBox.setItemText(4, _translate("mainWindow", "Year Level"))
        self.sortByComboBox.setItemText(5, _translate("mainWindow", "Program"))
        self.sortByComboBox.setItemText(6, _translate("mainWindow", "College"))
        self.idNumberLabel.setText(_translate("mainWindow", "ID Number"))
        self.nameLabel.setText(_translate("mainWindow", "Name"))
        self.genderLabel.setText(_translate("mainWindow", "Gender"))
        self.yearLevelLabel.setText(_translate("mainWindow", "Year Level"))
        self.programLabel.setText(_translate("mainWindow", "Program"))
