...
"}\n"
"\n"
"#sidebarFrame #programsSidebarButton {\n"
...
"}")
    ...
    self.addProgramButton = QtWidgets.QPushButton(parent=self.controlsFrame)
    sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(0)
    sizePolicy.setHeightForWidth(self.addProgramButton.sizePolicy().hasHeightForWidth())
    self.addProgramButton.setSizePolicy(sizePolicy)
    self.addProgramButton.setMaximumSize(QtCore.QSize(150, 16777215))
    font = QtGui.QFont()
    font.setFamily("Inter")
    font.setPointSize(9)
    font.setBold(True)
    ...
    self.horizontalLayout.addWidget(self.addProgramButton)
  ...
  def openAddProgramDialog(self):
    ...
    self.addDialog.programAddedTableSignal.connect(self.programTable.refreshDisplayPrograms)
