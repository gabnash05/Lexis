...
"}")
    ...
    def retranslateUi(self):
        ...
        self.searchByComboBox.setItemText(3, _translate("mainWindow", "First Name"))
        self.searchByComboBox.setItemText(4, _translate("mainWindow", "Last Name"))    
        self.searchByComboBox.setItemText(5, _translate("mainWindow", "Gender"))
        self.searchByComboBox.setItemText(6, _translate("mainWindow", "Year Level"))
        self.searchByComboBox.setItemText(7, _translate("mainWindow", "Program Code"))
        self.searchByComboBox.setItemText(8, _translate("mainWindow", "College Code"))
    ...
    def openAddStudentDialog(self):
        ...
        self.addDialog.studentAddedTableSignal.connect(self.studentTable.refreshDisplayStudents)
